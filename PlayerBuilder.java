...
public class PlayerBuilder {
	//attributes of a player
		...
		public Player build() {
			return new Player(hp, hpMax, mp, mpMax, weapon, atkSpell, healSpell, healthPotion, greatHealthPotion, manaPotion, greatManaPotion, arch, lvl, xp, gold, str, mnd, vit, src, xPos, yPos);
		}
